...
.chosen-container .chosen-results li.highlighted {
  ...
  background-image: -webkit-gradient(linear, left top, left bottom, color-stop(20%, ${color-success}), color-stop(90%, ${color-success}));
  background-image: linear-gradient(${color-success} 20%, ${color-success} 90%);
  color: #fff;
}
    </style>
</head>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="input-group panel-heading" style="width: 100%; background-color: ${color-success}; margin-bottom: 10px; text-align: left; font-family: Consolas;">
